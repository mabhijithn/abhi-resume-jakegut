...
\begin{center}
    ...
    \emph{Naturalized Belgian Citizen} $|$ \emph{Gent, Belgium} $|$ \emph{Available for relocation} $|$ \emph{Available for remote work} \\ \vspace{1pt}
\end{center}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Making sense of sensor data}
      \resumeItemListEnd
